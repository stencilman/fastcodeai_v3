export const blogDataList = [
  ...
  },
  {
    ...
    heroBackground: "bg-[#0b1a3b]",
    heroVariant: "simple",
    heroSubtitle: "6 Hard Lessons from Building an LLM Data Pipeline",
    thumbnail: "bg-[#0b1a3b]",
    comments: "0",
    category: "Data Engineering",
    description:
      "6 hard lessons we learned about moving from basic prompt writing to true LLM Systems Engineering — from mega-prompt failures to confidence detection hacks.",
  },
  {
