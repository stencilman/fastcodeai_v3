...
const RECOMMENDED_SLUGS = ["messy-data-platform", "flexa", "hardware-limitation"];
        ...
        <>
          ...
          <div className="flex flex-col gap-[20px]">
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              In Chapter 2, we showed how we built an AI pipeline that
              standardises 50,000 messy product names a day. This chapter is
              about everything that went wrong before we got there.
            </p>
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              When you first start working with Large Language Models, the
              instinct is to treat them like magic boxes. Just give them all
              your instructions, feed them the data, and watch the perfect
              output roll in.
            </p>
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              Our goal was to generate standardised product names, categories,
              and sizes from raw, messy alcohol data (mostly beer and wines) for
              an on-demand delivery marketplace. The standardised name had to be
...
{`{
  ...
  "Size": "16 oz x 4 ct"
            ...
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              ...
              lessons we learned about moving from basic prompt writing to true
          ...
          >
            ...
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              ...
              model consistently honoured every applicable constraint.
            </p>
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
          ...
          >
            ...
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              ...
              its primary output better.
            </p>
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              <b className="text-white">Why?</b> Because forcing the model to
              cite its source acts as a grounding mechanism. It forces
              accountability and drastically reduces hallucinations because the
              model cannot rely purely on its pre-trained knowledge — it has to
              point to the exact input field.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              ...
              frustrating. You find yourself asking, {'"Why on earth did it name the product that?"'}
            </p>
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
          ...
          >
            ...
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              ...
              them before finalising the output.
            </p>
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
          ...
          >
            ...
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              For our standardised product names, we used a triangulation
            ...
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              <b className="text-white">Consistency Checks:</b> We asked the
              model the exact same question multiple times. If the answer
              fluctuated, we manually flagged it as ambiguous.
            </p>
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              <b className="text-white">The Token-Time Proxy:</b> We analysed
              the time and token length of the {"model's"} reasoning. Even if
              the model eventually arrived at a conclusive answer, the very fact
              that it needed a massive amount of tokens to {'"talk itself"'}{" "}
              into the answer was mathematical proof that the model was
              confused. Long reasoning = high probability of ambiguity.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              If you missed Chapter 2 — the full case study on how we built
              this pipeline —{" "}
              <a
            ...
            <p className="text-[#9EB3CF] text-lg font-bwmss01">
              And if {"you're"} sitting on messy data at scale, this pattern
              works. {"We've"} seen it firsthand.
            </p>
